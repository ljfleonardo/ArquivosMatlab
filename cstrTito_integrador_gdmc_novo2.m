...
%%% para as duas outras saídas basta remover o polo instavel
% polos = unique(eig(expm(As*Ts)));
% I = find(abs(polos)>1);
% pz = polos(I); % obtem o polo indesejado (instável) de malha aberta
pz = 0.8187;
...
xlim([0 600])
hl = legend('y_i','r_i','Location','SouthEast')
